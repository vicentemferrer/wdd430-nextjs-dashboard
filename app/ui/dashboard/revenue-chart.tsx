...
function orderRevenue(revenue: Revenue[]) {
	...
	return revenue.toSorted(
		(a: Revenue, b: Revenue) => months.indexOf(a.month) - months.indexOf(b.month)
	);
}

export default async function RevenueChart() {
	const revenue = orderRevenue(await fetchRevenue());
